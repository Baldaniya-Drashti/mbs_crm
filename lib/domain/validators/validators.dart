import 'package:mbs_crm/core/error/failures.dart';
import 'package:mbs_crm/core/error/value_objects.dart';
import 'package:mbs_crm/core/error/value_validators.dart';
...
class OTPText extends ValueObject<String> {
  ...
  factory OTPText(String input) {
    return OTPText._(validateMaxStringLength(input, 4));
  }
...
class InputEmptyOrNot extends ValueObject<String?> {
  ...
  factory InputEmptyOrNot(String input) {
    return InputEmptyOrNot._(validateStringNotEmpty(input));
  }
...
class CardDate extends ValueObject<String?> {
  ...
  factory CardDate(String value) {
    return CardDate._(validateCardDate(value));
  }
...
class CVV extends ValueObject<String?> {
  ...
  factory CVV(String value) {
    return CVV._(validateCvv(value));
  }
